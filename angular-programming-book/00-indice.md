...
20. [Capítulo 20: CI/CD, Análisis de Bundles y Despliegue Continuo](20-cicd-y-despliegue.md)
    - Arquitectura de un pipeline CI/CD profesional para Angular
    - GitHub Actions: workflow completo de lint, test, build y deploy
    - Análisis automático de bundles: `source-map-explorer`, `webpack-bundle-analyzer`, budget alerts
    - Configuración de budgets en `angular.json`: límites de tamaño y alertas
    - Estrategias de despliegue: Firebase Hosting, Vercel, AWS (S3+CloudFront), Docker + Nginx
    - Despliegue de aplicaciones SSR: Firebase Cloud Functions, Cloud Run, AWS Lambda
    - Feature flags y despliegues canary
    - Monitoreo en producción: error tracking, performance monitoring y alertas
